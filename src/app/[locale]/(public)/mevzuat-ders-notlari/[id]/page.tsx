...
export default function MevzuatDersNotuDetailPage() {
  ...
  if (!note) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center animate-fade-in">
        ...
        <Link href="/mevzuat-ders-notlari" className="inline-flex items-center gap-2 text-primary hover:underline mt-4">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 animate-fade-in">
      ...
      <RelatedNotes notes={relatedNotes} basePath="/mevzuat-ders-notlari" />
    </div>
  );
}
